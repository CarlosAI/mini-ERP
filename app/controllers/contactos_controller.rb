class ContactosController < ApplicationController
  ...
  private
    ...
    def contacto_params
      params.require(:contacto).permit(:id_contacto, :apellido, :nombre, :id_tercero, :titulo, :puesto_trabajo, :direccion, :codigo_postal, :estado, :pais, :telefono_trabajo, :telefono_celular, :email)
    end
end
